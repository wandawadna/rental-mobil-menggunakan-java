...
//        initComponents();
    ...
    private void initComponents() {
        ...
        combotahun.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "2023", "2022", "2021", "2020", "2019", "2018", "2017", "2016", "2015", "2014", "2013", "2012", "2011", "2010", "2009", "2008", "2007", "2006", "2005", "2004", "2003", "2002", "2001", "2000" }));
        ...
        jLabel16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/icons8-traffic-jam-100.png"))); // NOI18N
        ...
        btn_create_addItem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/icons8-add-new-45.png"))); // NOI18N
        ...
        getContentPane().add(btn_create_addItem, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 390, 190, -1));

        btn_Edit_addItem.setForeground(new java.awt.Color(255, 255, 255));
        btn_Edit_addItem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/icons8-pencil-45.png"))); // NOI18N
        ...
        getContentPane().add(btn_Edit_addItem, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 390, 190, -1));

        btn_Refresh__addItem.setForeground(new java.awt.Color(255, 255, 255));
        btn_Refresh__addItem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/icons8-reset-45.png"))); // NOI18N
        ...
        getContentPane().add(btn_Refresh__addItem, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 390, 190, -1));

        btn_Delete__addItem.setForeground(new java.awt.Color(255, 255, 255));
        btn_Delete__addItem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/icons8-remove-45.png"))); // NOI18N
        ...
        getContentPane().add(btn_Delete__addItem, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 390, 190, -1));

        btn_Search_AddItem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/icons8-search-35.png"))); // NOI18N
        ...
        panelGlass6Layout.setHorizontalGroup(
            ...
            .addGroup(panelGlass6Layout.createSequentialGroup()
                .addGap(20, 20, 20)
                .addComponent(txt_search_AddItem, javax.swing.GroupLayout.DEFAULT_SIZE, 697, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
int i = tablemobil.getSelectedRow();
        ...
        String merek = txt_merkmobil_addItem.getText(); 
        String tipe = txt_TypeMbll_addItem.getText();
        String tahun = combotahun.getSelectedItem().toString();
        String nopol = txt_Nopol_addItem.getText();
        String harga = txt_Harga_addItem.getText();
        String status =combo_Status.getSelectedItem().toString();
        String Id = (String) model.getValueAt(i, 0);
        try{
        Connection c = KoneksiDatabase.getKoneksi();
        String sql = "UPDATE TB_MOBIL SET MEREK = ?, TIPE = ?, TAHUN = ?, NOPOL = ?, HARGA = ?, STATUS = ?"
                + "WHERE ID_MOBIL= ?";
    ...
    private void btn_create_addItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_create_addItemActionPerformed
        ...
        try{
        Connection c = KoneksiDatabase.getKoneksi();
        String sql = "INSERT INTO TB_MOBIL VALUES (id_mobil, ?, ?, ?, ?, ?, ?)";
...
try{
        ...
        Statement s = c.createStatement();
                ...
                while(r.next()){
                    ...
                    o[3] = r.getString("TAHUN");
                    o[4] = r.getString("NOPOL");
                    o[5] = r.getString("HARGA");
                    o[6] = r.getString("STATUS");
                    model.addRow(o);                            
            }
                r.close();
                s.close();
